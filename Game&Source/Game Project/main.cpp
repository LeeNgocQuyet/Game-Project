...
{
    srand(time(0));
    // khởi tạo đồ họa, âm thanh nền, sự kiện bàn phím/chuột
    Graphics graphics;
    graphics.init();
    ...
    //khởi tạo font text cho Menu và chức năng pause game
    ...
    // khởi tạo chương trình gồm menu, game và chức năng lưu trữ highscore
    while (isRunning) {
